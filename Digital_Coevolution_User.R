#########################################
### User script for Digital_Organism ####
#########################################
...
source.file.location <- "C://Local_Documents/PHD/R code/Digital_Daphnia/Digital_Coevolution/"
...
# should be saved.
result.file.location <- "C://Local_Documents/PHD/Data/Digital_Daphnia/"
