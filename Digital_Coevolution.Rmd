...
\newpage
# Introduction
Parasites are everywhere. They come in a plethora of forms and functions, but they all have in common that they need to infect a host for their livelihood. The impact of parasites on hosts, and especially on host populations is profound. Parasites can shape the genetic strucutre of host populations, they can facilitate or exclude coexistance of species, they can enable neobiotic expansion (well, their absence), and they are a prime candidate for being the reason sexual reproduction is maintained. Implicit to all those effects is that not all hosts (individuals, genotypes, lines, species...) are affected equally by parasites. Not all parasites are able to infect all hosts. Differences in infection success of different parasite genotypes on different host genotypes will shape the genetic structure of both host and parasite populations in a perpetual cycle of adaptation and counteradaptation. Constant change of genetic structure without a functional change of the relationship, the heart of the Red queen hypothesis (do all the running you can do, just to stay in the same place). 
The simplest example of this lies in negative frequency-dependent selection, where host and parasite genotype frequencies (ideally) show perpetual cylcles of dominance, caused by the negative correlation in fitness between the genotype frequencie of the host and the parasite. 
